							...
							@foreach ($catalog as $item)
								<div class="col-md-3 col-sm-6">
									<div class="jbi-item">
										...
										<a href="/jbi/{{ $item['id'] }}" class="jbi-item__btn">Весь каталог и просчет</a>
									</div>
								</div>
							@endforeach
						</div>
			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6 offset-lg-1 col-md-6">
						...
						<p class="individ-txt">
							Мы торговый дом. Торговая компания которая имеет три собственных ЖБИ завода.<br><br>Наш завод может сделать любое изделие из железеботана. За счет наличие собственного металлоцеха у нас есть возможность делать опалубочную систему любой сложности, и выполнять изделия любых форм железобетонных конструкций.<br><br>Каждый месяц мы изготавливаем более 12 000 товаров, что позволяет решать любую задачу клиента с минимальной стоимостью.<br><br>Все наши сотрудники - профессионалы своего дела с многолетним опытом работы. Они помогут Вам подобрать все необходимое для вашего объекта и учтут все пожелания при формировании заказа. мы гарантируем отгрузку заказов любого масштаба в кратчайшие сроки.
						</p>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-4 offset-lg-1 col-md-6">
						...
						<p class="about-txt">Наша компания всегда задумывается о том, что важно клиентам. Вся наша продукция соответствуют стандартам ГОСТ и ДСТУ. Наши клиенты оценят скорость просчёта, качество изделий, наименование и скорость изготовления.<br><br>Мы решаем задачи, которые непосильны другим! С нами застройщик экономит квадратные метры, ускоряет процес строительства и экономит деньги. Товар на складе в больших объемах. Вы найдёте в нашем лице надежного партнёра на которого можно положиться!</p>

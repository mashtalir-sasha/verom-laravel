				...
				<div class="row">
					<div class="col-md-4">
						<div class="service-item">
							...
							<p class="service-item__txt">Формы и оборудование для ЖБИ являются основным направлением деятельности нашей компании. Мы предлагаем изготовление металлоформ и оборудования как для строительства жилы, так х и промышленных помещений. Формы и оборудование ЖБИ, производимые в нашей компании, могут иметь различные модификации:</p>
							...
							<a href="#modal" class="service-item__btn fancybox" data-item="Изготовление металлоформ для применения в сфере производства ЖБИ">Просчет</a>
						</div>
					</div>
					<div class="col-md-4">
						<div class="service-item">
							...
							<ul class="service-item__list">
								<li>Проектирование, производство и монтаж металлоконструкций.</li>
								<li>Производство металлических ферм и опор.</li>
								<li>Ограждения, заборы.</li>
								<li>Лестницы, перила.</li>
								<li>Рекламные щиты.</li>         
								<li>Беседки, скамейки, козырьки.</li>
								<li>Металлокаркасы под мебель.</li>
							</ul>
							<a href="#modal" class="service-item__btn fancybox" data-item="Изготовление металлоконструкций">Просчет</a>
						</div>
					</div>
					<div class="col-md-4">
						<div class="service-item">
							...
							<p class="service-item__txt">Мы предоставляем услуги по эксклюзивной, художественной резке листового металла, а именно:</p>
							<ul class="service-item__list">
							...
							<a href="#modal" class="service-item__btn fancybox" data-item="Архитектурная резка металла">Просчет</a>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
						<div class="service-item">
							...
							<a href="#modal" class="service-item__btn fancybox" data-item="Производство кладочной сетки">Просчет</a>
						</div>
					</div>
					<div class="col-md-4">
						<div class="service-item">
							...
							<a href="#modal" class="service-item__btn fancybox" data-item="Плазменная резка и гибка металла">Просчет</a>
						</div>
					</div>
					<div class="col-md-4">
						<div class="service-item">
							...
							<p class="service-item__txt">Все виды металлоконструкций для мебели и интерьера. Наше производство имеет обширные возможности. Мы предлагаем Вам «ПОД ЗАКАЗ» изготовить изделия по Вашим эскизам ЛЮБОЙ СЛОЖНОСТИ по индивидуальному производству дизайнерских металлоконструкций для дома и офиса.</p>
							<a href="#modal" class="service-item__btn fancybox" data-item="Изготовление изделий для интерьера">Просчет</a>
						</div>
					</div>
				</div>
			</div>
